...
using ic = lib::integral_constant<T, val>;
...
void test01()
{
	const bool *p = &lib::integral_constant<bool, true>::value;
	(void)p;
}

typedef lib::true_type                      true_type;
typedef lib::false_type                     false_type;
